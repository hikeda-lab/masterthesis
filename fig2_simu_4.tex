...
\caption{simulation 4: 対数尤度関数の遷移}
...
\begin{figure} [h]
 ...
 \subfigure[$\delta_{1}$]{
 \label{fig_a} 
 \resizebox{5cm}{4cm}{\includegraphics{./fig/simu_4/hist_delta1.eps}}}
 \subfigure[$\delta_{2}$]{
 \label{fig_b} 
 \resizebox{5cm}{4cm}{\includegraphics{./fig/simu_4/hist_delta2.eps}}}
 \subfigure[$\delta_{3}$]{
 \label{fig_c}
 \resizebox{5cm}{4cm}{\includegraphics{./fig/simu_4/hist_delta3.eps}}}
 \label{fig_total}
 ...
 \subfigure[$\lambda_{1}$]{
 \label{fig_a} 
 \resizebox{5cm}{4cm}{\includegraphics{./fig/simu_4/hist_lambda1.eps}}}
 \subfigure[$\lambda_{2}$]{
 \label{fig_b} 
 \resizebox{5cm}{4cm}{\includegraphics{./fig/simu_4/hist_lambda2.eps}}}
 \subfigure[$\lambda_{3}$]{
 \label{fig_c}
 \resizebox{5cm}{4cm}{\includegraphics{./fig/simu_4/hist_lambda3.eps}}}
 \label{fig_total}
\caption{simulation 4: 各パラメータのヒストグラム}
